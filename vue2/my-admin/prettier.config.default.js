 ...
 * 只需要配置这就几项即可
 module.exports = {
  ...
  arrowParens: 'avoid', // 箭头函数只有一个参数时，是否给括号
  jsxBracketSameLine: false, // jsx开始标签的 jsx 是否在同一行
...
module.exports = {
   ...
   * default: "always"
   */
  // 箭头函数只有一个参数，是否有括号：js 无括号，ts 有括号
  arrowParens: 'avoid',
  // arrowParens: 'always',
  /**
   * Range 格式化范围
  ...
  // filepath: '',
  /**
   * Require pragma 是否格式化在文件顶部有特殊注释的文件，逐步格式化一个无格式化的工程，很有用
