/**
 * (function(global,fn){})(window,function(){
 *  console.log(2)
 * })
 */
;(function (global, factory) {
  ...
  const Sizzle =
    ...
    (function (window) {
      ...
      function siblingCheck(a, b) {
        let cur = b && a
        const diff = cur && a.nodeType === 1 && b.nodeType === 1 && a.sourceIndex - b.sourceIndex
      ...
      Expr = Sizzle.selectors = {
        ...
        pseudos: {
          ...
          lt: createPositionalPseudo(function (matchIndexes, length, argument) {
            let i = argument < 0 ? argument + length : argument > length ? length : argument
            for (; --i >= 0; ) {
              matchIndexes.push(i)
            }
            return matchIndexes
  ...
  jQuery.event = {
    ...
    dispatch: function (nativeEvent) {
      ...
      const handlers = (dataPriv.get(this, 'events') || Object.create(null))[event.type] || []
  ...
  function getWidthOrHeight(elem, dimension, extra) {
    ...
    let isBorderBox = boxSizingNeeded && jQuery.css(elem, 'boxSizing', false, styles) === 'border-box'
  ...
  jQuery.each(['height', 'width'], function (_i, dimension) {
    jQuery.cssHooks[dimension] = {
      ...
      set: function (elem, value, extra) {
        ...
        const scrollboxSizeBuggy = !support.scrollboxSize() && styles.position === 'absolute'
        // To avoid forcing a reflow, only fetch boxSizing if we need it (gh-3991)
        const boxSizingNeeded = scrollboxSizeBuggy || extra
        const isBorderBox = boxSizingNeeded && jQuery.css(elem, 'boxSizing', false, styles) === 'border-box'
        let subtract = extra ? boxModelAdjustment(elem, dimension, extra, isBorderBox, styles) : 0
