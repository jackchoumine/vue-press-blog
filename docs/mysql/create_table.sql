...
(
  dept_id INTEGER IDENTITY NOT NULL PRIMARY KEY,
  -- 部门编号，自增主键
...
CREATE TABLE job
(
  job_id INTEGER IDENTITY NOT NULL PRIMARY KEY,
  -- 职位编号，自增主键
...
(
  -- 员工编号，自增主键
  emp_id INTEGER IDENTITY NOT NULL PRIMARY KEY,
  -- 员工姓名
  ...
  CONSTRAINT ck_emp_sex CHECK (sex IN ('male', 'female')),
